...
pushd $FW_TARGETDIR >/dev/null
    ...
    touch mcu_ws/ros2/rosidl/rosidl_runtime_c/COLCON_IGNORE
    touch mcu_ws/ros2/rosidl/rosidl_generator_cpp/COLCON_IGNORE
    touch mcu_ws/ros2/rosidl/rosidl_runtime_cpp/COLCON_IGNORE
    touch mcu_ws/ros2/rosidl/rosidl_typesupport_interface/COLCON_IGNORE
    touch mcu_ws/ros2/rosidl/rosidl_typesupport_introspection_c/COLCON_IGNORE
    touch mcu_ws/ros2/rosidl/rosidl_typesupport_introspection_cpp/COLCON_IGNORE
    touch mcu_ws/ros2/rosidl/rosidl_typesupport_introspection_tests/COLCON_IGNORE
    touch mcu_ws/ros2/rosidl/rosidl_typesupport_introspection_cpp/COLCON_IGNORE
